    ...
    <div class="row">
        ...
        <main class="col-md-9 offset-1 ms-sm-auto">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ta'minotchi Qo'shish</h5>
            ...
            <table class="table mb-4">
                ...
                <tbody>
                <c:forEach items="${suppliers}" var="client" varStatus="loop">
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href="/supplier/delete/${client.id}">
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/supplier/update" method="post" id="update-form">
                                <div class="mb-3">
...
<script>
    window.addEventListener('DOMContentLoaded', (event) => {
        var categoryBar = document.getElementById('supplier-bar');
